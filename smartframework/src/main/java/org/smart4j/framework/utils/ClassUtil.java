...
/**
 * @author ：lopez
 * @date ：Created in 2019/12/18 19:43
 * @description：
 * @modified By：
 */
public class ClassUtil {
	...
	public static ClassLoader getClassLoader() {
    	...
    	System.out.println(currentThreadClassLoader.toString());
		System.out.println(currentThreadClassLoader.getParent().toString());
		System.out.println(currentThreadClassLoader.getParent().getParent().toString());
	...
	public static Class<?> loadClass(String className, boolean isInitalized) {
		Class<?> cls;
		try {
			//当isInitalized = true时，类会被初始化，若是false，类只会被装载
